(() => {
    ...
    function tabs() {
        ...
        //!Додавання функціоналу для Show More & Tabs
            ...
            if (tabsContent.length > 0) {
                ...
                if (typeof showMore !== "undefined" && typeof showMore.initShowMore === "function") showMore.initShowMore();
            }
        }
    ...
    let setActiveTitle = () => {};
    if (dropDownButton && dropDownGrid && dropDownList) {
        setActiveTitle = tab => {
            const tabActive = tab || document.querySelector("._tab-active");
            if (tabActive) dropDownButton.textContent = tabActive.textContent;
        };
        dropDownButton.addEventListener("click", (() => {
            dropDownGrid.classList.contains("dropdown__grid--open") ? dropDownGrid.classList.remove("dropdown__grid--open") : dropDownGrid.classList.add("dropdown__grid--open");
        }));
        [ ...dropDownList.children ].forEach((item => {
            item.addEventListener("click", (() => {
                if (dropDownGrid.classList.contains("dropdown__grid--open")) dropDownGrid.classList.remove("dropdown__grid--open");
            }));
        }));
        setActiveTitle();
    }
 ...
 //!Врахування чіткої висоти
    ...
    function initSliders() {
        if (document.querySelector(".all-category")) new swiper_core_Swiper(".swiper", {
            ...
            pagination: {
                ...
                renderBullet: function(index, className) {
                    ...
                    if (activeIndex > total / 2) {
                        if (index === activeIndex - 1) tpl = "b";
                        if (index === activeIndex - 2) tpl = "d";
                        if (index === activeIndex + 1) tpl = " ";
                    } else {
                        if (index === activeIndex - 1) tpl = "d";
                        if (index === activeIndex - 2) tpl = " ";
                        if (index === activeIndex + 1) tpl = "b";
                    }
                    if (index === activeIndex) tpl = "a"; else if (index === 0 || index === total - 1) tpl = "b"; else if (tpl === "" && (index === activeIndex + 2 || index === activeIndex + 2)) tpl = "d";
                    switch (tpl) {
                      case "b":
                        return `<span class="${className}">${index + 1}</span>`;

                      case "a":
                        return `<span class="swiper-pagination-bullet-active ${className}">${index + 1}</span>`;

                      case "d":
                        return `<span class="${className} dots">...</span>`;

                      default:
                        return `<span style="display:none!important;" class="${className}">${index + 1}</span>`;
                    }
                }
            },
            on: {
        ...
        if (document.querySelector(".breakfast-category")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".lunch-category")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".dinner-category")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".pizza-category")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".dessert-category")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".all-order")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".breakfast-order")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".lunch-order")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".dinner-order")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".pizza-order")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".dessert-order")) new swiper_core_Swiper(".swiper", {
            modules: [ Navigation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
